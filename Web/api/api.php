...
const DB = "wdmtf";
		...
		*/
		...
		private function uploadRefresh(){
			//$loadUploads = file_get_contents("http://127.0.0.1/projects/web/scripts/Update.php");		
			
			//$loadUploads = exec("php http://127.0.0.1/projects/web/scripts/Update.php");
			//echo $loadUploads;
		}
...
;
                                    ...
                                    {                                      
										...
										//file_get_contents("http://127.0.0.1/projects/web/scripts/run.php");
